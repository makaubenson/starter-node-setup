(function ($) {
  ...
  var modelApp = {
    ...
    menu: function () {
      ...
      var $submenu = $(
          "#mobile-main-nav .menu-list li, .overlay .overlay-menu"
        ).has(".sub-menu"),
        $submenuSelector = $(".sub-menu"),
        $mobileNavSelector = $("#main-mobile-container .main-navigation"),
        $mobileNavOverlay = $(
          ".mobile-menu-main .menucontent.overlaybg, .mobile-menu-main .slideLeft"
        ),
    ...
    mobileSelect: function () {
      var $selectSelector = $(
        ".apartment-menu-mobile, .blog-menu-mobile, .about-mobile"
      );
      $selectSelector.on("change", function (e) {
        var url = $(this).val();
        if ($.isNumeric(url) === true) {
          var $tabNav = $(
            ".apartment-menu li a, .post-filter-area li a, .about-tab li a"
          );
    ...
    scroll_top: function () {
      var $bodyElement = $("body"),
        $window = $(window),
        $scrollHtml = $(
          "<a href='#top' id='scroll-top' class='topbutton btn-hide'><span class='glyphicon glyphicon-menu-up'></span></a>"
        );
